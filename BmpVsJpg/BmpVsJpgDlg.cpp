...
{//����Դ�ļ�
	...
	{
		CFileDialog fileDialog(TRUE,NULL,NULL,NULL,"BMP�ļ�(*.bmp)|*.bmp|");
	...
	{
		CFileDialog fileDialog(TRUE,NULL,NULL,NULL,"JPG�ļ�(*.jpg)|*.jpg|");
...
{//����Ŀ���ļ�
	...
	if(m_CBmpToJpg.GetCheck())
	{
		CFileDialog fileDialog(FALSE,NULL,NULL,NULL,"JPG�ļ�(*.jpg)|*.jpg|");
	...
	{
		CFileDialog fileDialog(FALSE,NULL,NULL,NULL,"BMP�ļ�(*.bmp)|*.bmp|");
...
{//��ʼת��
	...
	{//JpgToBmp
		...
		int iColorBit = 24;//BMP��ɫλ�� ��24λBmp / ����ѡ��1��4��8λ	
		pDib->ConvertFormat(iColorBit);	// 24λBmp
